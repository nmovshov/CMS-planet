...
$(r,\mu)$ external to the planet is
\begin{equation}
...
calculate the shape functions of interior spheroids. We next derive an expression
for the total potential at an interior point on the boundary between spheroid $i$
and spheroid $i-1$.
