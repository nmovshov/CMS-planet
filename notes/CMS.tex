...
\begin{figure}[tb]
\centering
\includegraphics[{width=0.9\textwidth}]{cms_sketch}
...
\begin{equation}
V_{i<j,\mathrm{int}}(r_j,\mu) = \frac{G}{r_j(\mu)}\sumonk{r_j}(\mu)^{2k+1}\;
...
the $r_j^2$ term together with the $V_{i<j,\mathrm{ext}}$ contribution. And
