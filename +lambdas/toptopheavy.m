function lambdas = toptopheavy(N, skew, halftop)
...
%
%    lambdas = TOPTOPHEAVY(N, skew) returns a vector of normalized radii with
...
%    follow the same rule: skew(1) of those layers in the interval [1-skew(2)^2,1]
%    and the rest in the interval [1-skew(2),1-skew(2)^2].
%
