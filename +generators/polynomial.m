...
%    POLYNOMIAL(N, x) returns an N-point CMSPlanet object with rhoi approximated
%    by a single polynomial of z=a/a0, with coefficients x. The default level
%    spacing is one of equal radius increments between a/a0=1 and a/a0=1/N.
%    
%    POLYNOMIAL(N, x, zstrat) lets you specify the zvec distribution strategy.
...
%    1], for normalized equatorial layer radii.
%
%    POLYNOMIAL(...,forcemono) where forcemono==true forces the resulting density
