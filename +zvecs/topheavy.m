function zvec = topheavy(N, skew, I, halftop)
...
%
%    zvec = TOPHEAVY(N, skew, interval) returns a vector of normalized radii
%    with skew(1) of them equally distributed in the interval
%    [I(1)+(I(2)-I(1))*(1-skew(2)),I(2)] and the rest equally distributed in
%    the interval (I(1),I(1)+(I(2)-I(1))*(1-skew(2))].
%
%    zvec = TOPHEAVY(..., halftop) where halftop==true makes the thickness of
