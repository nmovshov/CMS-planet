...
%    a zero density barotropes.ConstDensity eos. The layer spacing is designed
%    to minimize discretization error by concentrating 2/3 of the available
%    layers in the top 0.5 of the planet (see Hubbard & Militzer, 2016). If
%    x(4)>=0.2 then layers are equally spaced above x(4).
