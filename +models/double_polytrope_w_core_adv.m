...
%    is at layer tind=fix(N*(1 - x(5))). Layer N is assigned a
%    barotropes.ConstDensity eos wirh rho0=x(6) and given a normalized
%    equatorial radius equal to x(7). Layer 1 is assigned a zero density
...
%    planet (see Hubbard & Militzer, 2016). However if x(7)>0.2 then layers are
%    equally spaced above x(7).
